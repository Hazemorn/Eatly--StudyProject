...
const Homepage = () => {
  ...
  const restaurants = [
    {
      id: 1,
      img: "../../homepage-image/our-top-restaurants/chicken-king.png",
      highlight: "Healthy",
    ...
    {
      id: 2,
      img: "../../homepage-image/our-top-restaurants/burger-king.png",
      highlight: "Trending",
  ...
  const dishes = [
    {
      id: 1,
      img: "../../homepage-image/our-top-dishes/chicken-hell.png",
      highlight: "Healthy",
      title: "Chicken Hell",
      min: "24min •",
      rate: "4.8",
    ...
    {
      id: 2,
      img: "../../homepage-image/our-top-dishes/swe-dish-01.png",
      highlight: "Trending",
      title: "Swe Dish",
      min: "34min •",
      rate: "4.9",
    ...
    {
      id: 3,
      img: "../../homepage-image/our-top-dishes/swe-dish-02.png",
      highlight: "Supreme",
      title: "Swe Dish",
      min: "24min •",
      rate: "4.9",
  ...
  const customers = [
    {
      id: 1,
      img: "../../homepage-image/customers/Alexander R.png",
      name: "Alexander R.",
      info: "01 Year With Us ",
      ...
      rate: "../../homepage-image/hero/stars.svg",
    },
    {
      id: 2,
      img: "../../homepage-image/customers/Alexander R.png",
      name: "Ryan X.",
      info: "03 Years With Us ",
            ...
            <div className={s.hero__text}>
              ...
              <div className={s.trustpilot__text}>
                <div className={s.trustpilot__left}>
                  <img
                    src="/homepage-image/hero/star-vector.svg"
                    alt="star_img"
                  />
                  <h3>Trustpilot</h3>
                </div>
      ...
      <section className={s.features}>
        <div className="container">
          <div className={s.features__content}>
            <div>
              <Feature title={feature[0].title} text={feature[0].text} /> <hr />
            </div>
            <div>
              <Feature title={feature[1].title} text={feature[1].text} /> <hr />
            </div>
        ...
        <div className="container">
          <div className={s.mobile__content}>
            <div className={s.mobile__img}>
              <img
                src="../../../homepage-image/download-app/mobile.png"
                alt="telephone"
              />
            </div>
            <div className={s.mobile__info}>
              ...
              <button className={s.mobile__btn}>
                <p>Download</p>
                <img
                  src="../../../homepage-image/download-app/arrow.svg"
                  alt="arrow"
                />
              </button>
              <img
                className={s.mobile__twisted_arrow}
                src="../../../homepage-image/download-app/arrow-vector.png"
                alt="twisted arrow"
              />
            </div>
          </div>
